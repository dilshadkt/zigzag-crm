      ...
      >
        ...
        {filteredProjects?.map((project, index) => (
         ...
         cursor-pointer  relative rounded-2xl px-4
          ...
          h-0 ${selectProject === project?._id && `h-full`
