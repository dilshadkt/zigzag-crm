  ...
  return (
    ...
    >
      <div className="space-y-4 pb-1">
        ...
        {meeting.description ? (
          <p className="text-xs leading-relaxed text-[#7D8592]">{meeting.description}</p>
        ) : null}

        <div className="flex flex-wrap gap-2.5 text-xs text-[#7D8592]">
        ...
        {meeting.meetLink ? (
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#3F8CFF] hover:underline disabled:opacity-50"
          >
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {people.map((person) => (
              <span
                key={person._id}
                className="inline-flex items-center gap-1.5 rounded-full bg-[#F4F9FD] px-2.5 py-1 text-[11px] font-medium text-gray-700"
              >
