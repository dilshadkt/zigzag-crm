...
export const useAddTaskForm = (defaultValue, onSubmit) => {
  const initialValues = {
    ...
    timeEstimate: defaultValue?.timeEstimate || "",
    ...
    sequentialSubtasks: defaultValue?.sequentialSubtasks || false,
